        ...
        <div className='px-4 pt-14 pb-8 flex w-full lg:p-0 lg:h-screen lg:max-h-screen lg:min-h-[768px]'>
            <div className='flex flex-col items-center justify-between w-full   lg:w-1/2 lg:px-4 lg:pt-14 lg:pb-8'>
                ...
                <div className='w-full h-full flex flex-col items-center justify-center lg:w-1/2'>
                        ...
                        {({ handleSubmit}) => {
                            ...
                            return (
                                <Form onSubmit={handleSubmit} className={'mt-8 flex flex-col gap-5 w-full '}>
                                    ...
                                    <div className={'mt-1'}>
                                    <Button  text={'Login'} type={'submit'} variant={'primary'} wFull={true}/>
                                    </div>
                                </Form>
                            )
                        }
                    ...
                    <Button onClick={signupWithGoogle} text={'Sign in with Google'} type={'button'} variant={'secondary'} wFull={true} isSocial={true} extraClass={'mt-4'}/>

                    <div className='flex mt-8'>
                    <p>Don’t have an account?</p>
                        <Button text={'Sign up'} type={'submit'} variant={'link'} extraClass={'ml-1'}/>
                    </div>
